        ...
        <div className="flex flex-col lg:items-start">
          ...
          <div className="flex items-center gap-5 mt-6 md:mt-8">
            {socialMedia.map((icon) => (
              <div
                className="flex justify-center items-center w-8 h-8 sm:w-12 smh-12 bg-white rounded-full cursor-pointer"
                key={icon.alt}
              >
            ...
            <div key={section.title}>
              ...
              <ul>
                {section.links.map((link) => (
                  <li
                    className="mt-1 md:mt-3 font-montserrat text-sm-base leading-normal transition duration-300 text-white-400 hover:text-slate-gray dark:hover:text-dark-slate-gray cursor-pointer"
                    key={link.name}
                  >
