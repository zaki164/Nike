  ...
  return (
    ...
    >
      ...
      <div className="relative xl:w-2/5 flex flex-col justify-center items-start w-full pt-28">
        ...
        <h1 className="mt-6 md:mt-10 text-8xl max-sm:text-[62px] max-sm:leading-[72px] font-bold">
        ...
        <p className="font-montserrat text-slate-gray text-base-l leading-8 mt-3 md:mt-6 mb-10 md:mb-14 sm:max-w-sm">
